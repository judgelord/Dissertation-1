...
stargazer(mod1_num_ann_pubs_house_lagged, mod1_prop_ann_violate_sen_lagged, mod2_anyviol_house_lagged, mod2_anyviol_sen_lagged, mod3_anyviol_house_mixed_lagged, mod3_anyviol_sen_robust_lagged,
          ...
          title="Main Regression Results, Chapter 3", 
...
stargazer(mod2_anyviol_aff_lagged, mod3_anyviol_affect_mixed_lagged, mod3_anyviol_aff_robust_lagged,
          ...
          title="Regression Results: Log Odds of Retired Military Officer Commentary Violating Principles of Civil-Military Relations (controlling for measures of affective polarization)", 
...
predictions%>%
  ...
  geom_text(aes(x=70.72, label="2009",y=.5), colour="dodgerblue", angle=90, vjust=1, text=element_text(size=9)) + 
  geom_text(aes(x=79.75, label="2013",y=.65), colour="dodgerblue", angle=90, vjust=-.2, text=element_text(size=9)) + 
  geom_text(aes(x=82.60, label="2017",y=.65), colour="tomato", angle=90, vjust=-.2, text=element_text(size=9))  + 
  geom_text(aes(x=84.01, label="2021", y=.65), colour="dodgerblue", angle=90, vjust=1, text=element_text(size=9))
```
...
predictionshouse%>%
  ...
  geom_text(aes(x=80.45, label="2009",y=.5), colour="dodgerblue", angle=90, vjust=1.1, text=element_text(size=9)) + 
  geom_text(aes(x=88.15, label="2017",y=.65), colour="tomato", angle=90, vjust=1.2, text=element_text(size=9))  + 
  geom_text(aes(x=87.26, label="2021", y=.65), colour="dodgerblue", angle=90, vjust=-.3, text=element_text(size=9))
```
